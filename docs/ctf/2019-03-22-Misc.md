...
8. 二维码
   -- 扫不出来用微信, CortexScan
   -- 图片修复: https://merricx.github.io/qrazybox/
...
11. wav/音频隐写 https://www.sqlsec.com/2018/01/ctfwav.html
    -- 1.Audition/Audacity看 多是摩斯码, 2.看频谱spectrogram(视图-频谱)/ audacity 轨道左侧文件名箭头-频谱 3.听歌 4.misc_dtmf.zip
    -- 效果-反向 听声音。
    -- 删除多余文件头，可能有2段riff
    -- SilentEye
