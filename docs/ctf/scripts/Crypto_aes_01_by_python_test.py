import unittest
from Crypto_aes_01_by_python import AES, encrypt, decrypt
...
class TestBlock(unittest.TestCase):
    ...
    def test_expected_basic(self):
        ...
        aes = AES(bytes(key))
        ciphertext = aes.encrypt_block(bytes(message))
        self.assertEqual(ciphertext, bytes.fromhex('8D835D0CFFD8BAD585FE8B4294C42188'))
